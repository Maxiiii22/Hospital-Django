# Generated by Django 5.1.6 on 2025-10-04 21:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('disponible', 'Disponible'), ('ocupado', 'Ocupado'), ('mantenimiento', 'En mantenimiento'), ('fuera_servicio', 'Fuera de servicio')], default='disponible', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servicio_diagnostico', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hospital_personal.serviciodiagnostico')),
