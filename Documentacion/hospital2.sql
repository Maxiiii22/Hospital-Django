...
-- Volcando estructura de base de datos para hospital2
CREATE DATABASE IF NOT EXISTS `hospital2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `hospital2`;

-- Volcando estructura para tabla hospital2.auth_group
...
-- Volcando datos para la tabla hospital2.auth_group: ~0 rows (aproximadamente)

-- Volcando estructura para tabla hospital2.auth_group_permissions
...
-- Volcando datos para la tabla hospital2.auth_group_permissions: ~0 rows (aproximadamente)

-- Volcando estructura para tabla hospital2.auth_permission
...
-- Volcando datos para la tabla hospital2.auth_permission: ~68 rows (aproximadamente)
...
-- Volcando estructura para tabla hospital2.controlusuario_departamento
...
-- Volcando datos para la tabla hospital2.controlusuario_departamento: ~11 rows (aproximadamente)
INSERT INTO `controlusuario_departamento` (`id`, `nombre_departamento`, `tipo`, `descripcion`) VALUES
...
-- Volcando estructura para tabla hospital2.controlusuario_especialidades
CREATE TABLE IF NOT EXISTS `controlusuario_especialidades` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `nombre_especialidad` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla hospital2.controlusuario_especialidades: ~31 rows (aproximadamente)
INSERT INTO `controlusuario_especialidades` (`id`, `nombre_especialidad`, `descripcion`) VALUES
	(1, 'Medicina de Urgencias', 'Se ocupa del diagnóstico y tratamiento de enfermedades o lesiones que requieren atención médica inmediata.'),
	(2, 'Trauma y Cirugía de Urgencias', 'Atiende lesiones graves, como fracturas o heridas profundas, que requieren intervención quirúrgica urgente.'),
	(3, 'Medicina Crítica', 'Atención intensiva para pacientes graves o que requieren soporte vital.'),
	(4, 'Medicina General', 'Atención primaria para pacientes de todas las edades, con diagnóstico y tratamiento de enfermedades comunes.'),
	(5, 'Endocrinología', 'Trata enfermedades relacionadas con el sistema endocrino, como diabetes, trastornos de tiroides y problemas hormonales.'),
	(6, 'Oftalmología', 'Diagnóstico y tratamiento de enfermedades y trastornos oculares.'),
	(7, 'Otorrinolaringología', 'Enfoque en trastornos de los oídos, nariz y garganta.'),
	(8, 'Cirugía General', 'Realización de procedimientos quirúrgicos para tratar diversas condiciones médicas, como apendicitis o hernias.'),
	(9, 'Cirugía Plástica y Reconstructiva', 'Procedimientos para restaurar la apariencia física después de accidentes o enfermedades, incluyendo cirugías estéticas.'),
	(10, 'Medicina Intensiva', 'Manejo de pacientes en estado crítico que requieren monitoreo constante y tratamiento especializado.'),
	(11, 'UCI Cardiovascular', 'Cuidados intensivos para pacientes con insuficiencia cardíaca, infartos o cirugía cardíaca reciente.'),
	(12, 'UCI Respiratoria', 'Tratamiento especializado para pacientes con fallos respiratorios graves, como aquellos con insuficiencia respiratoria o neumonía severa.'),
	(13, 'Radiología General', 'Uso de rayos X para obtener imágenes del cuerpo y ayudar en el diagnóstico de enfermedades como fracturas o infecciones.'),
	(14, 'Resonancia Magnética (RM)', 'Técnica que utiliza imanes y ondas de radio para obtener imágenes detalladas de los órganos y tejidos internos.'),
	(15, 'Ecografía/Doppler', 'Uso de ondas sonoras para crear imágenes del cuerpo y evaluar la circulación sanguínea, a menudo utilizada en el embarazo.'),
	(16, 'Mamografía', 'Examen de imágenes de la mama para detectar cáncer de mama en etapas tempranas.'),
	(17, 'Bioquímica Clínica', 'Análisis de muestras biológicas, como sangre o orina, para evaluar las funciones metabólicas y diagnosticar enfermedades.'),
	(18, 'Microbiología', 'Análisis de muestras para detectar infecciones bacterianas, virales y fúngicas.'),
	(19, 'Inmunología', 'Estudio del sistema inmunológico y su respuesta a infecciones, alergias y enfermedades autoinmunes.'),
	(20, 'Farmacia Clínica', 'Uso adecuado de medicamentos para tratar enfermedades y mejorar la calidad de vida de los pacientes.'),
	(21, 'Farmacia Hospitalaria', 'Gestión de los medicamentos dentro del hospital, asegurando su correcta distribución y administración.'),
	(22, 'Oncología Médica', 'Tratamiento del cáncer utilizando medicamentos como quimioterapia, inmunoterapia y terapias dirigidas.'),
	(23, 'Oncología Radioterápica', 'Tratamiento del cáncer mediante radiación, con el fin de destruir células tumorales.'),
	(24, 'Cirugía Oncológica', 'Intervención quirúrgica para extirpar tumores cancerosos y tejidos afectados.'),
	(25, 'Pediatría General', 'Atención integral para niños y adolescentes, desde la prevención hasta el tratamiento de enfermedades comunes.'),
	(26, 'Ginecología General', 'Diagnóstico y tratamiento de afecciones ginecológicas, como infecciones, fibromas y cáncer.'),
	(27, 'Obstetricia', 'Atención médica a mujeres durante el embarazo, el parto y el postparto.'),
	(28, 'Perinatología', 'Atención médica especializada para embarazos de alto riesgo.'),
	(29, 'Dermatología General', 'Tratamiento de afecciones comunes de la piel, como acné, eczema y psoriasis.'),
	(30, 'Dermatología Estética', 'Procedimientos cosméticos para mejorar la apariencia de la piel, como láser o Botox.'),
	(31, 'Venereología', 'Diagnóstico y tratamiento de enfermedades de transmisión sexual.');

-- Volcando estructura para tabla hospital2.controlusuario_jorna_laboral
CREATE TABLE IF NOT EXISTS `controlusuario_jorna_laboral` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `dia` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `turno` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla hospital2.controlusuario_jorna_laboral: ~28 rows (aproximadamente)
INSERT INTO `controlusuario_jorna_laboral` (`id`, `dia`, `turno`) VALUES
	(1, 'lunes', 'dia'),
	(2, 'martes', 'dia'),
	(3, 'miercoles', 'dia'),
	(4, 'jueves', 'dia'),
...
-- Volcando estructura para tabla hospital2.controlusuario_menoracargodepaciente
...
-- Volcando datos para la tabla hospital2.controlusuario_menoracargodepaciente: ~2 rows (aproximadamente)
INSERT INTO `controlusuario_menoracargodepaciente` (`id`, `parentesco`, `adulto_id`, `menor_id`) VALUES
	(1, 'HIJO', 1, 2),
	(2, 'HIJO', 1, 3);

-- Volcando estructura para tabla hospital2.controlusuario_paciente
...
-- Volcando datos para la tabla hospital2.controlusuario_paciente: ~3 rows (aproximadamente)
INSERT INTO `controlusuario_paciente` (`id`, `direccion`, `persona_id`) VALUES
	(1, 'Calle Falsa 123', 2),
	(2, '', 5),
	(3, '', 6);

-- Volcando estructura para tabla hospital2.controlusuario_persona
CREATE TABLE IF NOT EXISTS `controlusuario_persona` (
  ...
  `login_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Volcando datos para la tabla hospital2.controlusuario_persona: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla hospital2.controlusuario_persona_groups
...
-- Volcando datos para la tabla hospital2.controlusuario_persona_groups: ~0 rows (aproximadamente)

-- Volcando estructura para tabla hospital2.controlusuario_persona_user_permissions
...
-- Volcando datos para la tabla hospital2.controlusuario_persona_user_permissions: ~0 rows (aproximadamente)

-- Volcando estructura para tabla hospital2.controlusuario_roles
CREATE TABLE IF NOT EXISTS `controlusuario_roles` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `nombre_rol` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla hospital2.controlusuario_roles: ~3 rows (aproximadamente)
INSERT INTO `controlusuario_roles` (`id`, `nombre_rol`) VALUES
	(1, 'Superadministrador'),
	(2, 'Director del hospital'),
	(3, 'Médico');

-- Volcando estructura para tabla hospital2.controlusuario_usuario
CREATE TABLE IF NOT EXISTS `controlusuario_usuario` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `numero_matricula` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Volcando datos para la tabla hospital2.controlusuario_usuario: ~3 rows (aproximadamente)
INSERT INTO `controlusuario_usuario` (`id`, `numero_matricula`, `debe_cambiar_contraseña`, `persona_id`, `rol_id`) VALUES
	(1, NULL, 0, 1, 1),
	(2, '10000', 1, 3, 3),
	(3, '10010', 1, 4, 3);

-- Volcando estructura para tabla hospital2.controlusuario_usuarioxdepartamentoxjornada
...
-- Volcando datos para la tabla hospital2.controlusuario_usuarioxdepartamentoxjornada: ~2 rows (aproximadamente)
INSERT INTO `controlusuario_usuarioxdepartamentoxjornada` (`id`, `jornada_id`, `usuario_id`, `departamento_id`) VALUES
	(1, 1, 3, 0),
	(2, 2, 3, 0);

-- Volcando estructura para tabla hospital2.controlusuario_usuarioxespecialidad
CREATE TABLE IF NOT EXISTS `controlusuario_usuarioxespecialidad` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `usuario_id` bigint NOT NULL,
  `nombre_profesion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Volcando datos para la tabla hospital2.controlusuario_usuarioxespecialidad: ~1 rows (aproximadamente)
INSERT INTO `controlusuario_usuarioxespecialidad` (`id`, `usuario_id`, `nombre_profesion`) VALUES
	(3, 3, 'Dermatólogo');

-- Volcando estructura para tabla hospital2.django_admin_log
...
-- Volcando datos para la tabla hospital2.django_admin_log: ~80 rows (aproximadamente)
...
-- Volcando estructura para tabla hospital2.django_content_type
...
-- Volcando datos para la tabla hospital2.django_content_type: ~17 rows (aproximadamente)
...
-- Volcando estructura para tabla hospital2.django_migrations
...
-- Volcando datos para la tabla hospital2.django_migrations: ~24 rows (aproximadamente)
...
-- Volcando estructura para tabla hospital2.django_session
...
-- Volcando datos para la tabla hospital2.django_session: ~4 rows (aproximadamente)
