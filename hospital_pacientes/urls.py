...
urlpatterns = [
    ...
    path("turnos/reprogramar-estudio/<int:turno_id>/", views.reprogramarTurnoEstudio, name="reprogramarTurnoEstudio"),
    path("turnos/cancelar/<int:turno_id>/", views.cancelarTurno, name="cancelarTurno"),
    path("turnos/cancelar-estudio/<int:turno_id>/", views.cancelarTurnoEstudio, name="cancelarTurnoEstudio"),
